...
public:
    ...
    void percorrer();
    void redimensiona(int novaCapacidade); // int c, string v);
...
void TabelaHash::redimensiona(int novaCapacidade){ //int c, string v){
    
    int capOld = cap;
    Noh **tabelaAux;
    tabelaAux = new Noh*[capOld];
    //Noh *aux = NULL;
    ...
    for (int i = 0; i < capOld; i++)
    {
        cout << "posicão " << tabelaAux[i]->chave << endl;
    }
}
